...
def local():
  ...
  test_df = pd.read_csv(
    "https://github.com/c038644/Git/files/P7_test_df.csv")

  Selected_Customer = pd.read_csv(
    "https://github.com/c038644/Git/files/selection.csv")
  ...
  ten_most_important_df.to_csv(
    "https://github.com/c038644/Git/files/Customer_score.csv")
...
def global_data():
  ...
  test_df = pd.read_csv("https://github.com/c038644/Git/files/P7_test_df.csv")
  ...
  Global_Features.to_csv("https://github.com/c038644/Git/files/Global_Features.csv")
