...
with st.spinner('Updating Report...'):
    ...
    Customer_ID = pd.read_csv("C:/Users/Farida/Documents/Data_Science/Projects/Streamlit/ID_column.csv")
    ...
    fig2 = go.Figure(go.Indicator(
        ...
        gauge = {
            ...
            'steps': [
                ...
                {'range': [0.25, 0.35], 'color': 'orange'},
                {'range': [0.35, 1], 'color': 'green'}],
            'threshold': {
    ...
    #fig = px.bar(global_graph_df, x = 'Feature', y='Importance', template = 'seaborn')
